...
def app(image_dir,threads,model):
    ...
    for i in range(len(out_q)):
        ...
        #print(listimage[i],ground_truth,'=>',prediction)
...
def main():
  ...
  ap.add_argument('-m', '--model',     type=str, default='dobble_classifier.xmodel', help='Path of xmodel. Default is dobble_classifier.xmodel')
